...
function NewsDepartmentPage({ posts }: NewsPageProps) {
  const handleFilterChange = () => {};
  return (
    <PageWrapper>
      <ContentContainer>
        <H1>Aktuelle News - Tennis</H1>
        <FilterContainer>
          <Select
            id="topics"
            name="topics"
...
export default NewsDepartmentPage;
...
export async function getStaticPaths() {
  ...
  const paths = departments.map((department: { uid: string }) => ({
    params: { abteilung: department.uid },
  }));
